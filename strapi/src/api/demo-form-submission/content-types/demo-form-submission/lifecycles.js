module.exports = {
  async afterCreate(event) {
    ...
    const sendNotification = async () => {
      try {
        console.log("Sending demo form notification email...");
          ...
          html: `
                ...
                <html>
                  <head>
                    ...
                    <title>New Demo Form Submission</title>
                  ...
                  <body>
                    <div class="container">
                      ...
                      <div class="content">
                        <h1 class="title">New Demo Form Submission</h1>
                      ...
                      <div class="footer">
                        <p>This is an internal notification from the UnivDatos website demo form.</p>
                      </div>
                    </div>
                  </body>
                </html>
        ...
        console.log("Successfully sent demo form notification");
        return true;
      } catch (error) {
        console.error("Failed to send demo form notification:", {
          error: error.message,
          stack: error.stack,
          submission: {
